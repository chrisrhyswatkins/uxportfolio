<nav class="show-for-medium">
	<ul class="nav-list <?php echo $navColor; ?>">
		<li<?php if($activeNav == '1') {echo " class='current-menu-item'";}?>><a <?php if($activeNav == '1') {echo " href='#work-anchor' class='samepageanchor'";} else {echo " href='/#work-anchor'";}?>>work</a></li>
